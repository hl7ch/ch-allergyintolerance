...
Alias: $allergyintolerance-category = http://hl7.org/fhir/allergy-intolerance-category
Alias: $CHAllergyIntoleranceReactionManifestationValueSet = http://fhir.ch/ig/ch-allergyintolerance/ValueSet/CHAllergyIntoleranceReactionManifestationValueSet
Alias: $CHAllergyIntoleranceConditionValueSet = http://fhir.ch/ig/ch-allergyintolerance/ValueSet/CHAllergyIntoleranceConditionValueSet
Alias: $CHAllergyIntoleranceReactionSubstanceValueSet = http://fhir.ch/ig/ch-allergyintolerance/ValueSet/CHAllergyIntoleranceReactionSubstanceValueSet
Alias: $CHAllergyIntoleranceValueSet = 	http://fhir.ch/ig/ch-allergyintolerance/ValueSet/CHAllergyIntoleranceValueSet
